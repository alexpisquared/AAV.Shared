...
namespace MVVM.Common
{
  ...
  public abstract class BindableBase : INotifyPropertyChanged
  {
    ...
    protected bool Set (ref string storage, string value, ObservableCollection<string> comboList, [CallerMemberName] string? propertyName = null)
    {
      if (object.Equals(storage, value)) return false;
      ...
      if (comboList != null)
      {
        ...
        {
          if (storage != null && comboList.Contains(storage))
            comboList.Remove(storage);
        }
        else if (value != null && !comboList.Contains(value))
          comboList.Add(value);
      }
