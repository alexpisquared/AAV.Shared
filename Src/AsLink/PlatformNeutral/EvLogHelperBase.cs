...
public static partial class EvLogHelper //this is the latest copy as of 2021-09-10. 
{
  ...
  public static void LogScrSvrBgn(int App_Ssto_Gp, string msg = "ScrSvr - Up. ScreenSaveTimeOut + GracePeriod 1 min") { try { EventLog.WriteEntry(_aavSource, $"{msg}(sec) ={App_Ssto_Gp}", EventLogEntryType.Information, 7101); } catch (Exception ex) { _ = ex.Log(); } }// AavSource finds the log named AavNewLog    
